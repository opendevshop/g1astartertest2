...
[![Travis CI](https://travis-ci.org/opendevshop/g1astartertest2.svg?branch=master)](https://travis-ci.org/opendevshop/g1astartertest2)
[![Windows CI](https://ci.appveyor.com/api/projects/status/{{PUT_APPVEYOR_STATUS_BADGE_ID_HERE}}?svg=true)](https://ci.appveyor.com/project/opendevshop/g1astartertest2)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/opendevshop/g1astartertest2/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/opendevshop/g1astartertest2/?branch=master)
[![Coverage Status](https://coveralls.io/repos/github/opendevshop/g1astartertest2/badge.svg?branch=master)](https://coveralls.io/github/opendevshop/g1astartertest2?branch=master) 
...
[![License](https://poser.pugx.org/opendevshop/g1astartertest2/license)](https://github.com/opendevshop/g1astartertest2//master/LICENSE)
-->
...
| Feature                   | Setup
| ------------------------- | ----------------
| Collaborative repository  | [DONE](https://github.com/opendevshop/g1astartertest2)
| Linux permutation testing | [DONE](https://travis-ci.org/opendevshop/g1astartertest2)
...
deploy:
  ...
  on:
    tags: true
    repo: opendevshop/g1astartertest2
```
...
- [GitHub issue templates](https://github.com/opendevshop/g1astartertest2/issues/templates/edit)
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [releases](https://github.com/opendevshop/g1astartertest2/releases) page.

## Authors

* **Jon Pugh** - created project from template.

See also the list of [contributors](https://github.com/opendevshop/g1astartertest2/contributors) who participated in this project.
